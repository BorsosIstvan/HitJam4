...
<head>
    ...
    <script src="comp_winamp_visualizer.js"></script>
...
<body>
    <div class="app-container" id="hitjamApp">
        ...
        <audio id="partyAudioEngine" src="<?= htmlspecialchars($preview_url, ENT_QUOTES, 'UTF-8') ?>" crossorigin="anonymous" preload="auto"></audio>
